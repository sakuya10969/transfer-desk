/**
 * @generated SignedSource<<4620f19cbaae3e864d576510f45ca315>>
...
export type CreateContractMutation$variables = {
  object: contracts_insert_input;
};
export type CreateContractMutation$data = {
  readonly insert_contracts_one: {
    readonly clause: number | null | undefined;
    readonly club_id: any;
...
export type CreateContractMutation = {
  response: CreateContractMutation$data;
  variables: CreateContractMutation$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "ab69ad2b020acbf94e9cf266b5f80027",
    "id": null,
    "metadata": {},
    "name": "CreateContractMutation",
    "operationKind": "mutation",
    "text": "mutation CreateContractMutation(\n  $object: contracts_insert_input!\n) {\n  insert_contracts_one(object: $object) {\n    id\n    player_id\n    club_id\n    start_date\n    end_date\n    salary\n    clause\n  }\n}\n"
  }
};
})();

(node as any).hash = "0c30821b1a19a4ac900c1102df33f08e";
