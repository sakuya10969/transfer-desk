/**
 * @generated SignedSource<<bdbe8d99593d61ca30ae2b68f8ddfabf>>
...
export type ClubsListQuery$variables = {
  limit: number;
  offset: number;
  order_by?: ReadonlyArray<clubs_order_by> | null | undefined;
  where?: clubs_bool_exp | null | undefined;
};
export type ClubsListQuery$data = {
...
export type ClubsListQuery = {
  response: ClubsListQuery$data;
  variables: ClubsListQuery$variables;
};
