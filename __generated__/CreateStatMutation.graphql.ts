/**
 * @generated SignedSource<<ab48f173567d5e0b6a4b34a3bbf49432>>
...
export type CreateStatMutation$variables = {
  object: stats_insert_input;
};
export type CreateStatMutation$data = {
  readonly insert_stats_one: {
...
export type CreateStatMutation = {
  response: CreateStatMutation$data;
  variables: CreateStatMutation$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "b309c226c5ad2f6bfd4f8c6dc790a898",
    "id": null,
    "metadata": {},
    "name": "CreateStatMutation",
    "operationKind": "mutation",
    "text": "mutation CreateStatMutation(\n  $object: stats_insert_input!\n) {\n  insert_stats_one(object: $object) {\n    id\n    season\n    player_id\n    club_id\n    matches\n    goals\n    assists\n  }\n}\n"
  }
};
})();

(node as any).hash = "7dd62dd63cd263c576c86797ce20f718";
